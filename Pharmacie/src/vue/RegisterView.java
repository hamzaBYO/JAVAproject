...
public class RegisterView extends JFrame {
    ...
    /** Retourne "" si le champ affiche encore son placeholder gris, sinon la vraie valeur. */
    private String clean(JTextField f) {
        if (f.getForeground().equals(Color.GRAY)) return "";
        return f.getText().trim();
    }

    public String getId()       { return clean(txtId); }
    public String getCin()      { return clean(txtCin); }
    public String getNom()      { return clean(txtNom); }
    public String getPrenom()   { return clean(txtPrenom); }
    public String getEmail()    { return clean(txtEmail); }
